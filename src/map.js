...
const MyMapComponent = withScriptjs(
  ...
  <GoogleMap
      ...
      <Marker   className="marker"  label="1" title="St. Jude Primary School" position={{lat: 50.851267, lng: -1.2010895}} />
      <Marker   className="marker"  label="2" title="Sacred Heart Church"     position={{lat: 50.851218, lng: -1.178828}} />
